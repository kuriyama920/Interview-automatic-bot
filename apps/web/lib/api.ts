...
const PLAN_PRICE_MAP: Record<string, string> = {
  pro: process.env.NEXT_PUBLIC_STRIPE_PRO_PRICE_ID || 'price_1SxvG5EQOoOtNgU2bxdJTbMr',
  max: process.env.NEXT_PUBLIC_STRIPE_MAX_PRICE_ID || 'price_1SxvGoEQOoOtNgU2Ac3Xx7nb',
}
