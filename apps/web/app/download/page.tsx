...
export const metadata: Metadata = {
  ...
  description:
    'InterviewBotの最新版をダウンロード。Windows 10/11対応。',
}
    ...
    <div className="pt-16">
      ...
      <section className="py-16">
        <div className="max-w-md mx-auto px-4 sm:px-6">
          <DownloadCard
            title="インストーラー版"
            description="デスクトップとスタートメニューにショートカットを作成。アンインストーラー付き。"
            asset={installer}
...
function DownloadCard({
  ...
  return (
    <div className="p-6 rounded-2xl border border-accent bg-surface shadow-elevated">
      ...
      <a
        href={downloadUrl}
        className="mt-5 flex items-center justify-center gap-2 w-full py-3 rounded-xl text-sm font-medium transition-colors bg-accent text-white hover:bg-accent-hover"
      >
