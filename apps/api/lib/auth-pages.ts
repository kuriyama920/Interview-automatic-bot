 ...
 * 認証成功ページを表示
 */
export function showSuccessPage(res: VercelResponse, userName: string) {
  const html = `
<!DOCTYPE html>
<html lang="ja">
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .hint-icon { display: inline-block; margin-right: 0.5rem; opacity: 0.7; }
    ...
    (function() {
      ...
      if (downloadBtn && document.referrer) {
        try {
          ...
          var downloadUrl = referrerUrl.origin + '/download';
 ...
 * エラーページを表示
 */
export function showErrorPage(res: VercelResponse, error: string) {
  const html = `
<!DOCTYPE html>
<html lang="ja">
<head>
