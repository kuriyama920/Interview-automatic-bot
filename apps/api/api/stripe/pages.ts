/**
 * Stripe HTML ページ統合エンドポイント
 * GET /api/stripe/success - Checkout 成功ページ
 * GET /api/stripe/cancel - Checkout キャンセルページ
 */

import { VercelRequest, VercelResponse } from '@vercel/node'
import { getRoute } from '../../lib/routing'

function handleSuccess(_req: VercelRequest, res: VercelResponse) {
  const html = `
<!DOCTYPE html>
<html lang="ja">
<head>
...
<body>
  ...
  <div class="container">
    ...
    <div class="hint">
      このウィンドウを閉じて、Interview Bot アプリに戻ってください。プランは自動的に反映されます。
    </div>
...
function handleCancel(_req: VercelRequest, res: VercelResponse) {
  const html = `
<!DOCTYPE html>
<html lang="ja">
<head>
