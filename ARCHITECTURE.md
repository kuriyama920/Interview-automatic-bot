...
| 機能 | Free | Pro (¥2,980/月) | Max (¥14,800/月) |
|------|------|-----------------|----------------------|
| STT認識時間 | 30分/月 | 600分/月 | 3,000分/月 |
| AI生成トークン | 30,000/月 | 500,000/月 | 5,000,000/月 |
| ストレージ | 50MB | 1GB | 10GB |
| ドキュメント数 | 3件 | 50件 | 200件 |
| カスタムAPIキー | - | ✓ | ✓ |
| オフラインモード | ✓ | ✓ | ✓ |
...
**コスト**:
- GPT-5 Mini: $0.00025/1k tokens (入力), $0.002/1k tokens (出力)
